        ...
        return(
            ...
            <div className="short-describe">
                <p className="text-container">
                    ...
                    Let me show you some of Jacob Fugger's career below. If, having read it, you would like to know more about Fugger, read <q>The Richest Man Who Ever Lived: The Life and Times of Jacob Fugger</q> by Greg Steinmetz, whose book has inspired me to make this app.
                    </Typing>
                </p>
            </div>
